...
modify the contents of the `src/crosmos/lib/` and `examples/` directories.
...
```sh
$ pip install git+ssh://git@github.com/crosmos-labs/crosmos-python-sdk.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/crosmos-labs/crosmos-python-sdk/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
