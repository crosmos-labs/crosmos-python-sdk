...
These methods return an [`APIResponse`](https://github.com/crosmos-labs/crosmos-ts-sdk/tree/main/src/crosmos/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/crosmos-labs/crosmos-ts-sdk/tree/main/src/crosmos/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
